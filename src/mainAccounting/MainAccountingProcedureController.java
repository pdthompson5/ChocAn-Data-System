...
public class MainAccountingProcedureController {
    ...
    private String memberPath = "src/reports/weekly/members/";
    private String providerPath = "src/reports/weekly/providers/";
    private String eftSummaryPath = "src/reports/weekly/";
